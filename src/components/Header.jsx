      ...
      <div className="flex flex-col fadeLeftMini">
        ...
        <div className='md:py-6 sm:py-4 py-2'>
          <input
            ...
            md:w-96 sm:w-72 w-44 font-manrope md:text-sm text-[0.5rem] 
        ...
        <div className="lg:mt-16 md:mt-4 mt-1">
          ...
          <div className="flex mt-2 justify-start">
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Buzz} alt="Buzz" />
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Chase} alt="Chase" />
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Microsoft} alt="Microsoft" />
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Gucc} alt="Gucc" />
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Airbnb} alt="Airbnb" />
            <img className='mr-3 md:mr-5 sm:mr-4 md:w-14 sm:w-12 w-8 shadow p-1' src={Uber} alt="Uber" />
          </div>
        </div>
      </div>
