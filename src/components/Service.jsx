  ...
  return (
    <div id='service' className='flex flex-col mt-10 px-2 sm:px-6 lg:px-5'>
      ...
      <div className="flex lg:flex-row flex-col md:m-5 md:px-0 px-1 bg-[rgb(241,255,255)]">
        ...
        <div className="flex flex-col md:-mt-40 -mt-14 lg:mt-10 mb-10 lg:ml-8 md:ml-6 md:-mr-8 lg:mr-16">
          <h1 className="font-manrope text-sm md:text-3xl lg:text-[2rem] leading-5 md:leading-10 font-semibold md:pl-0 pl-1 lg:pr-14 my-4 lg:my-6 md:mr-0">The and collecting for the motionless difficulty son.</h1>
          <span className="font-manrope md:text-sm text-[0.65rem] text-text-black md:pr-48">This modern smartspace is simply stunning and comfortable.</span>
